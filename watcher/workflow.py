...
class Workflow:
    @staticmethod
    def run_agent_command(context: TaskContext) -> int:
    ...
    def execute_task(cls, issue: Issue):
        ...
        try:
            ...
            return_code = cls.run_agent_command(context)
            
            if return_code == 0:
                # 4. Finalization (Push & PR)
                if cls.finalize_task(context):
    ...
    @classmethod
    def finalize_task(cls, context: TaskContext) -> bool:
